...
\begin{tabular}{|p{1.75cm}|p{2.5cm}|p{10.75cm}}
	...
	\multicolumn{1}{p{1.75cm}}{\code{max.names}} & \multicolumn{1}{p{2.5cm}}{Un valor entero.} & \multicolumn{1}{p{10.75cm}}{El número máximo de nombres que será devuelto. Un \code{-1} indicará que el único límite en el número de nombres devueltos será el de la extensión máxima de los vectores en R.}\\
